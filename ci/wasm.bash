...
wasm-pack test --firefox --headless -- --no-default-features --features "bindgen timer"
wasm-pack test --firefox --headless -- --no-default-features --features "async_std"
wasm-pack test --firefox --headless -- --no-default-features --features "async_global timer"
